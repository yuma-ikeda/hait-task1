...

{
 "cells": [
  ...
  },
  {
   ...
   "source": [
    "pd.get_dummies(Data_train['Embarked'])"
   ]
  },
  {
   "cell_type": "code",
   ...
   "outputs": [
    {
     ...
     "text": [
      ...
      "15           16         1       2    1  55.0      0      0  16.0000         0\n",
      "16           17         0       3    0   2.0      4      1  29.1250         0\n",
      "17           18         1       2    0   NaN      0      0  13.0000         0\n",
      "18           19         0       3    1  31.0      1      0  18.0000         0\n",
      "19           20         1       3    1   NaN      0      0   7.2250         1\n"
     ]
    }
   ],
   "source": [
    "Data_train['Sex']=pd.get_dummies(Data_train['Sex'])\n",
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "df = Data_train.fillna(Data_train.mean())"
   ]
  },
  {
   "cell_type": "code",
